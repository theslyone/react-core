            ...
            React.createElement(Switch, null,
                ...
                React.createElement(Route, { path: "/", render: function () {
                        return createElement(appLayout, {
                            ...
                            theme: theme,
                            title: title,
                        }, React.createElement(RoutesWithLayout, { catchAll: catchAll, customRoutes: customRoutes.filter(function (route) { return !route.props.noLayout; }), dashboard: dashboard, title: title }, Children.map(
                        // @ts-ignore
                        childrenToRender, function (child) {
                            return cloneElement(child, {
                                key: child.props.name,
