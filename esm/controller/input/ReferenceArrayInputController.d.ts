...
export declare class UnconnectedReferenceArrayInputController extends Component<Props & EnhancedProps> {
    ...
    setPagination: (pagination: Pagination) => void;
    setSort: (sort: Sort) => void;
    fetchReferences: (nextProps: any, currentProps?: Readonly<Props & EnhancedProps> & Readonly<{
        children?: ReactNode;
    }>) => void;
    fetchOptions: (props?: Readonly<Props & EnhancedProps> & Readonly<{
        children?: ReactNode;
    }>) => void;
    fetchReferencesAndOptions(nextProps: any, currentProps?: Readonly<Props & EnhancedProps> & Readonly<{
        children?: ReactNode;
    }>): void;
    render(): ReactNode;
}
