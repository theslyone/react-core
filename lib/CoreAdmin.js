...
var CoreAdminBase = /** @class */ (function (_super) {
    ...
    CoreAdminBase.prototype.render = function () {
        ...
        store = store || createAdminStore_1.default({
        ...
        return this.reduxIsAlreadyInitialized ? (this.renderCore()) : (react_1.default.createElement(react_redux_1.Provider, { store: store }, this.renderCore()));
    };
