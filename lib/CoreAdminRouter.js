...
var CoreAdminRouter = /** @class */ (function (_super) {
    ...
    CoreAdminRouter.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", null,
            ...
            // @ts-ignore
            childrenToRender, function (child) {
            ...
            react_1.default.createElement(react_router_dom_1.Switch, null,
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: "/", render: function () {
                        return react_1.createElement(appLayout, {
                            ...
                            theme: theme,
                            title: title,
                        }, react_1.default.createElement(RoutesWithLayout_1.default, { catchAll: catchAll, customRoutes: customRoutes.filter(function (route) { return !route.props.noLayout; }), dashboard: dashboard, title: title }, react_1.Children.map(
                        // @ts-ignore
                        childrenToRender, function (child) {
                            return react_1.cloneElement(child, {
                                key: child.props.name,
